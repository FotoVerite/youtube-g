    ...
    class VideoFeedParser < FeedParser #:nodoc:
      ...
      protected
        def parse_entry(entry)
          ...
          if entry.elements["gd:comments"] && entry.elements["gd:comments"].elements["gd:comments"]
            comment_count = entry.elements["gd:comments"].elements['gd:feedLink'].attributes['countHint'].try(:to_i)
          end
